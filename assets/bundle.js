...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataloader = __webpack_require__(2);
	...
	var _timeseriesHandler = __webpack_require__(6);
	
	var _timeseriesHandler2 = _interopRequireDefault(_timeseriesHandler);
	
	var _barchartHandler = __webpack_require__(9);
	
	var _barchartHandler2 = _interopRequireDefault(_barchartHandler);
	
	var _arcDiagram = __webpack_require__(10);
	
	var _arcDiagram2 = _interopRequireDefault(_arcDiagram);
	...
	var crossfilter = __webpack_require__(22); /*jshint esversion: 6*/
	...
	// GENDER BREAKDOWN
	var gender = {};
	gender.svg = d3.select("#gender-svg").attr("width", function () {
	    return this.parentNode.clientWidth;
	...
	var age = {};
	age.svg = d3.select("#age-svg").attr("width", function () {
	    return this.parentNode.clientWidth;
	...
	var tripsCf = void 0,
	    municipalitySet = d3.set(),
	    bikeIdsArray = void 0,
	    stationDetailsMap = {};
	var bikeDimension = void 0;
	//Load data
	//Once loaded, populate all modules
	_dataloader2.default.on('dataloaded', function (data) {
	    ...
	    if (urlParams.bikeid) {
	        _dataloader2.default.loadJson("./processedData/bike_" + urlParams.bikeid + "_2016.json");
	        d3.select("#share").on("click", function () {
	            copyToClipboard(window.location.href);
	        });
	    } else {
	        var selectedBikeId = selectRandomBike();
	        d3.select("#share").on("click", function () {
	            copyToClipboard(window.location.href + "?bikeid=" + selectedBikeId);
	        });
	        _dataloader2.default.loadJson("./processedData/bike_" + selectedBikeId + "_2016.json");
	    }
	});
	
	function selectRandomBike() {
	    var index = parseInt(Math.random() * bikeIdsArray.length);
	    var selectedBikeId = bikeIdsArray[index];
	...
	_dataloader2.default.on("dataloadedjson", function (trips) {
	    ...
	    trips = trips.filter(function (d) {
	        return d.startMunicipality && d.endMunicipality;
	    });
	    tripsCf = crossfilter(trips);
	
	    var lineChartModule = (0, _timeseriesHandler2.default)(trips, timeline.plot, timeline.canvas);
	    lineChartModule();
	
	    var ageCategorisationFn = function ageCategorisationFn(d) {
	        if (d.birthYear) {
	            var diff = parseInt(2017 - d.birthYear);
	            if (diff < 18) {
	                return "0-17";
	            } else if (diff < 26) {
	                return "18-25";
	    ...
	    var ageChart = (0, _barchartHandler2.default)(trips, age.plot, age.canvas, ageCategorisationFn);
	    var genderChart = (0, _barchartHandler2.default)(trips, gender.plot, gender.canvas);
	    var scaleX = d3.scaleLinear().domain([0, d3.max([ageChart.maxValue(), genderChart.maxValue()])]);
	    var ageScaleY = d3.scaleBand().domain(["0-17", "18-25", "26-40", "41-65", "65+", "Unknown"]);
	    genderChart.scaleX(scaleX)();
	    ageChart.scaleX(scaleX).scaleY(ageScaleY)();
	
	    var yAxisBtns = d3.select("#timeseries-y-axis");
	    yAxisBtns.selectAll("button").on("click", function () {
	        yAxisBtns.selectAll("button").classed("active", false);
	        d3.select(this).classed("active", true);
	        var scaleX = d3.scaleLinear().domain([0, d3.max([ageChart.maxValue(this.dataset.key), genderChart.maxValue(this.dataset.key)])]);
	        var ageScaleY = d3.scaleBand().domain(["0-17", "18-25", "26-40", "41-65", "65+", "Unknown"]);
	        genderChart.scaleX(scaleX);
	        ageChart.scaleX(scaleX).scaleY(ageScaleY);
	    ...
	    var municipalityChart = (0, _arcDiagram2.default)(trips, municipality.plot, municipality.canvas, stationDetailsMap);
	    municipalityChart();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Dataloader() {
	  var _dis = (0, _d.dispatch)('dataloaded', 'dataloaderror', "dataloadedjson", "dataloadedcsv");
	
	  function exports() {}
	
	  exports.loadCsv = function (url, parse) {
	    var successEvent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "dataloadedcsv";
	    var errorEvent = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "dataloaderror";
	
	    (0, _d.csv)(url, parse, function (err, data) {
	      if (err) {
	  ...
	  exports.loadJson = function (url) {
	    var successEvent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "dataloadedjson";
	    var errorEvent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "dataloaderror";
	
	    (0, _d.json)(url, function (err, data) {
	      if (err) {
	        _dis.call(errorEvent, null, err);
	      } else {
	        _dis.call(successEvent, null, data);
	  ...
	  exports.queue = function (urls, queueFns, parseFns) {
	    ...
	    var queueObj = (0, _d.queue)();
	    urls.forEach(function (url, i) {
	      if (queueFns[i] == _d.json) {
	...
	var dataloader = Dataloader(); //dataloader == exports
	...
	dataloader.queue(["./data/Hubway_Stations_2011_2016.csv", "./processedData/bikeIds.json"], [_d.csv, _d.json], [stationsParse, null]);
	
	exports.default = dataloader; //What did we export?
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Menu() {
		...
		var _dis = (0, _d.dispatch)('arrangeBy:all', 'arrangeBy:country', 'search');
		...
		function exports(selection) {
			...
			selection.append('span').attr('class', 'navbar-brand').text('Arrange by: ');
			var buttons = selection.append('ul').attr('class', 'nav navbar-nav');
			buttons.append('li').attr('class', 'active').append('a').attr('href', '#').on('click', function () {
				_d.event.preventDefault();
				_dis.call('arrangeBy:all');
			}).text('All Journalists');
			buttons.append('li').append('a').attr('href', '#').on('click', function () {
				_d.event.preventDefault();
			...
			var searchBar = (0, _SearchBar2.default)();
			searchBar.on('search:submit', function (val) {
				_dis.call('search', null, val);
			});
	
			selection.append('form').attr('class', 'navbar-form navbar-left').datum(datum).call(searchBar);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SearchBar() {
	  ...
	  var _dis = (0, _d.dispatch)('search:submit');
	  ...
	  function exports(selection) {
	    ...
	    var input = selection.append('div').attr('class', 'form-group').append('input').attr('type', 'text').attr('class', 'form-control').attr('placeholder', 'Search for journalist');
	
	    var submitButton = selection.append('button').attr('class', 'btn btn-default').attr('type', 'submit').text('Search');
	
	    selection.on('submit', function () {
	      _d.event.preventDefault(); //otherwise page will reload
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createLineChart(data, plot, canvasSize) {
	    ...
	    function exports() {
	        var yaxis = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "number";
	        var breakdownAxis = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "userType";
	
	        var rollUpFn = function rollUpFn(d) {
	            return d.length;
	        };
	        if (yaxis == "duration") {
	            rollUpFn = function rollUpFn(d) {
	        ...
	        var nest = d3.nest().key(function (d) {
	            ...
	            return +a - +b;
	        }).rollup(rollUpFn).entries(_data);
	        nest.forEach(function (d) {
	            d.key = +d.key;
	        });
	
	        d3.range(1, 54, 1).forEach(function (i) {
	            if (nest.filter(function (d) {
	                return d.key == i;
	            }).length === 0) {
	        ...
	        var scaleX = d3.scaleLinear().domain([1, 54]).range([0, _canvas.width]);
	        var scaleY = d3.scaleLinear().domain([0, d3.max(nest, function (d) {
	            return d.value;
	        })]).range([_canvas.height, 0]);
	
	        var timeseries = (0, _lineChart2.default)().x(function (d) {
	            return scaleX(d.key);
	        }).y(function (d) {
	            return scaleY(d.value);
	        });
	
	        var g = _plot.select("g.timeseries");
	        if (!g.node()) {
	            g = _plot.append("g").classed("timeseries", true);
	        }
	        var commulative = g.select("g.commulative");
	        if (!commulative.node()) {
	            commulative = g.append("g").classed("commulative", true);
	        }
	        commulative.datum(nest).call(timeseries);
	
	        var breakdown = g.select("g.breakdown");
	        if (!breakdown.node()) {
	            breakdown = g.append("g").classed("breakdown", true);
	        }
	
	        var keys = d3.extent(_data, function (d) {
	            return d[breakdownAxis];
	        });
	        var breakdownNest = d3.nest().key(function (d) {
	            return d[breakdownAxis];
	        }).key(function (d) {
	            return d.week;
	        }).rollup(rollUpFn).entries(_data);
	        breakdownNest.forEach(function (d) {
	            d.values.forEach(function (e) {
	                e.key = +e.key;
	            });
	            d3.range(1, 55, 1).forEach(function (i) {
	                if (d.values.filter(function (d) {
	                    return d.key === i;
	                }).length === 0) {
	        ...
	        var commulation = d3.range(1, 55, 1).map(function (d) {
	            return 0;
	        });
	        breakdownNest.forEach(function (d) {
	        ...
	        paths.exit().remove();
	        paths.enter().append("path").merge(paths).datum(function (d, i) {
	            return d;
	        }).call(timeseriesArea);
	
	        // TAKING CARE OF THE AXIS
	        var axisX = d3.axisBottom().scale(scaleX).tickFormat(function (d) {
	            return "week " + d;
	        }).tickSize(_canvas.height);
	        var axisY = d3.axisLeft().scale(scaleY).tickSize(-_canvas.width).ticks(5);
	        ...
	        var axisYG = g.select(".axisY");
	        if (!axisYG.node()) {
	            axisYG = g.append("g").attr("class", "axis axisY");
	        }
	        axisYG.transition().call(axisY);
	
	        var axisXG = g.select(".axisX");
	        if (!axisXG.node()) {
	            axisXG = g.append("g").attr("class", "axis axisX");
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function lineChart() {
	    ...
	    function exports(selection) {
	        ...
	        var lineGen = (0, _d.line)().x(_x).y(_y);
	
	        path.datum(data).transition().attr("d", lineGen);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function areaChart() {
	    ...
	    function exports(selection) {
	        var areaGen = (0, _d.area)().x(_x).y1(_y1).y0(_y0);
	
	        selection //.datum(d=>d)
	        .transition().attr("d", areaGen);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createBarChart(data, plot, canvasSize) {
	    var xaxis = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function (d) {
	        return d.gender;
	    };
	    ...
	    function exports() {
	        ...
	        var nest = d3.nest().key(_xaxis).rollup(rollUpFn).entries(_data);
	
	        if (!_scaleY) {
	            _scaleY = d3.scaleBand().domain(nest.map(function (d) {
	                return d.key;
	            }));
	        }
	        _scaleY.range([0, _canvas.height]).paddingInner(0.3).paddingOuter(0.3).align(0.5);
	        if (!_scaleX) {
	            _scaleX = d3.scaleLinear().domain([0, d3.max(nest, function (d) {
	                return d.value;
	            })]);
	        }
	        _scaleX.range([0, _canvas.width]);
	        var g = _plot.select("g.barChart");
	        if (!g.node()) {
	            g = _plot.append("g").classed("barChart", true);
	        }
	
	        // TAKING CARE OF THE AXIS
	        var axisX = d3.axisTop().scale(_scaleX).tickFormat(function (d) {
	            return d;
	        }).tickSize(_canvas.height);
	        var axisY = d3.axisLeft().scale(_scaleY).tickSize(-_canvas.width).ticks(5);
	
	        if (yaxis == "duration") {
	            var minStep = _scaleX.domain()[1] / 5;
	            var step = parseInt(minStep) + parseInt(parseInt(minStep) / (60 * 60));
	        ...
	        var axisXG = g.select(".axisX");
	        if (!axisXG.node()) {
	            axisXG = g.append("g").attr("class", "axis axisX").attr("transform", "translate(0, " + _canvas.height + ")");
	        }
	        axisXG.transition().call(axisX);
	
	        var bars = g.selectAll("rect").data(nest, _xaxis);
	        bars.exit().transition().style("opacity", "0").remove();
	        bars.enter().append("rect").attr("height", _scaleY.bandwidth()).attr("y", function (d) {
	            return _scaleY(d.key);
	        }).merge(bars).transition().attr("width", function (d) {
	            return _scaleX(d.value);
	        }).attr("x", 0);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createArcDiagram(data, plot, canvasSize, stationDetailsMap) {
	    ...
	    function exports() {
	        ...
	        var array = ["Somerville", "Brookline", "Boston", "Cambridge"];
	        _scaleX = d3.scaleOrdinal().domain(array).range(d3.range(50, _canvas.width, _canvas.width / array.length));
	
	        var g = _plot.select("g.arcDiagram");
	        if (!g.node()) {
	            g = _plot.append("g").classed("arcDiagram", true);
	        }
	        var dummy = d3.select(document.createElement("div")).append("svg");
	        _scaleY = d3.scaleLinear().domain([0, +d3.max(_data, function (d) {
	            return +d.duration;
	        })]).range([_canvas.height - 50, 0]);
	        var lineGen = d3.line().curve(d3.curveMonotoneX);
	        var paths = g.selectAll("path").data(_data);
	        paths.exit().transition().remove();
	        paths.enter().append("path").merge(paths).attr("d", function (d) {
	            var startX = _scaleX(d.startMunicipality);
	            var endX = _scaleX(d.endMunicipality);
	            var midX = (startX + endX) / 2;
	            var midY = _scaleY(d.duration);
	            var path = dummy.append("path").attr("d", lineGen([[startX, _canvas.height], [midX, midY], [endX, _canvas.height]]));
	            ...
	            return d.pathLength;
	        }).transition().duration(10000).delay(function (d, i) {
	            return 100 * i;
	        }).attr("stroke-dashoffset", 0);
	
	        // AXIS HANDLER
	        var axisX = d3.axisBottom().scale(_scaleX).tickSize(0);
	        var axisXG = g.select(".axisX");
	        if (!axisXG.node()) {
	            axisXG = g.append("g").attr("class", "axis axisX").attr("transform", "translate(0, " + _canvas.height + ")");
	        }
	        ...
	        var axisY = d3.axisLeft().scale(_scaleY).tickSize(-_canvas.width).ticks(5);
	        var minStep = +_scaleY.domain()[1] / 5;
	        var step = parseInt(minStep) + parseInt(parseInt(minStep) / (60.0 * 60));
	        axisY.tickFormat(function (d) {
	            return (d / (60 * 60)).toFixed(2) + " hours";
	        });
	        var axisYG = g.select(".axisY");
	...
	exports.default = createArcDiagram;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body, html {\n    margin: 0px;\n    padding: 0px;\n    background: #1D2041;\n}\n\nh1 {\n    color: white;\n    text-align: center;\n    margin-top: 10px;\n    margin-bottom: 10px;\n}\nh1.title {\n    margin-top: 50px;\n    margin-bottom: 80px;\n}\np {\n    color: white;\n}\na {\n    color: rgba(255, 255, 255, 0.6);\n}\nsection {\n    margin-bottom: 50px;\n}\n#timeseries-y-axis {\n    display: inline-block;\n}\n#buttons {\n    margin-bottom: 20px;\n}\n.btn {\n    padding: 5px;\n    border: 0 none;\n    font-size: 14px;\n    /*font-weight: 700;*/\n    background: none;\n    color: rgb(180, 180, 250);\n    /*text-transform: uppercase;*/\n}\n.btn.active {\n    color: rgb(180, 180, 250);\n    font-size: 14px;\n    border-bottom: 2px solid rgb(180, 180, 250);\n}\n.btn:hover {\n    background: none;\n    color: rgb(180, 180, 250);\n}\n.btn:focus, .btn:active:focus, .btn.active:focus {\n    outline: 0 none;\n    background: none;\n    color: rgb(180, 180, 250);\n    font-size: 14px;\n    border-bottom: 2px solid rgb(180, 180, 250);\n}\n\n.lead {\n    color: white;\n}\nsvg {\n    background: #1D2041;\n}\n\n.color-box {\n    width: 30px;\n    height: 20px;\n    display: inline-block;\n    margin-right: 10px;\n    margin-left: 10px;\n}\n\n.color-box.subscriber {\n    background: rgba(170, 255, 170, 0.6);\n}\n.color-box.casual {\n    background: rgba(170, 170, 255, 0.6);\n}\n\ng.timeseries g.commulative path {\n    fill: none;\n    stroke: white;\n    stroke-width: 1;\n}\n\ng.timeseries g.breakdown g.userTypeSubscriber path {\n    fill: rgba(170, 255, 170, 0.6);\n    stroke: none;\n}\ng.timeseries g.breakdown g.userTypeCustomer path {\n    fill: rgba(170, 170, 255, 0.6);\n    stroke: none;\n}\n\ng.barChart rect {\n    fill: rgba(255, 255, 255, 0.6);\n}\n\ng.arcDiagram path {\n    fill: none;\n    stroke: rgba(120, 120, 170, 0.6);\n    stroke-width: 1;\n    mix-blend-mode: screen;\n}\n\ng.axis path {\n    stroke: none;\n}\ng.axis g.tick text {\n    fill: #557;\n    font-size: 1.2em;\n}\n/*g.timeseries g.axisX g.tick line {\n    stroke: none;\n}*/\ng.axis g.tick line {\n    stroke-dasharray: 1, 5;\n    stroke-linecap:round;\n    stroke: #557;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(23).crossfilter;
